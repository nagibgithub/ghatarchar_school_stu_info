...
const Teacher = ({ teacher }) => {
    ...
    //     Swal.fire({ title: `Delete <br/> ${teacher_name}?`, imageUrl: teacher_photo, text: "Are you sure?", showConfirmButton: true, showCancelButton: true, confirmButtonText: "Delete", confirmButtonColor: "#ff0000" }).then(res => {
    //         if (res.isConfirmed) {
    ...
    //                                     if (element._id !== id) { newUserData.push(element); }
    //                                 });
