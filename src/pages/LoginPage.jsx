        ...
        <div className="flex justify-center items-center flex-col gap-3 my-5">
            {
                ...
                :
                <>
                    <img className="rounded-full border-2 border-white shadow" src={userInfo?.photoURL} alt="" />
                    ...
                    <button onClick={callSignOut} className="btn btn-error font-bold text-red-950">Sign Out</button>
                </>
            }
        </div>
    );
