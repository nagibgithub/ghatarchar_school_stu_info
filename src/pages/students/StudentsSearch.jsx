...
const StudentsSearch = () => {
    ...
    return (
        <div className="mx-2">
            {/* <PageTile link="/students" mainTitle={"Search Students"} subTitle={"Search By Id"}></PageTile> */}
            <div>
                {
                    stuArrLoading ?
                        <Loading></Loading>
                        ...
                        <div className="flex flex-col border-2 border-sky-600 rounded-2xl px-2 pb-2 bg-sky-100 shadow-md gap-1">
                            ...
                            <div className="flex flex-col gap-2">
                                {/* <h1 className="text-center font-bold text-sky-800">{searchArr.length === 0 ? "No" : searchArr.length} Students found</h1> */}
                                {
                                    activeStu ?
