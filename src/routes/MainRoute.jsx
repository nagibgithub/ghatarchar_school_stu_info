...
const router = createBrowserRouter([
    {
        ...
        children: [
            ...
            { path: "/add_student", element: <PrivateRoute><AddStuHome></AddStuHome></PrivateRoute> },
            ...
            { path: "/add_student/:batch", element: <PrivateRoute><AddStudent></AddStudent></PrivateRoute> },
